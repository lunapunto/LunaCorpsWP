...
},{"./scripts/global.js":2,"./scripts/main.js":3,"./scripts/velocity":4,"flickity":13,"google-fonts":20,"jquery":24,"jquery-bridget":21,"jquery-confirm":22,"jquery-lazy":23}],2:[function(require,module,exports){
(function (global){
/*
* Helper () isset
* Devuelve si un elemento exista dada su clase
*/
global.isset = function(selector){
  return ($(selector).length ? true : false);
}

global.is_waypoint = function(e){
...
global.hexToRGBA = function(hex, a){
    var c;
    if(!a){
      a = 1;
    }
...
global.toggleClassCond = function(element, cl, cond){
  if(element.hasClass(cl) && !cond){
...
global.ismobileFunction = function() {
  var check = false;
...
global.ismobile = ismobileFunction();

global.alertS = function(title, text, buttons, dontsubmit){
  $.confirm({
    title: title,
    content: text,
    theme: 'customtheme',
...
global.gotosection = function(id){
  $('body,html').animate({
    scrollTop: $(id).offset().top + (hmenu / 2)
  }, 600);
}
...
},{"./flickity":12,"fizzy-ui-utils":7}],9:[function(require,module,exports){
// animate
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"fizzy-ui-utils":7}],10:[function(require,module,exports){
// Flickity.Cell
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./flickity":12,"fizzy-ui-utils":7,"unidragger":26}],12:[function(require,module,exports){
// Flickity main
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./animate":9,"./cell":10,"./slide":18,"ev-emitter":6,"fizzy-ui-utils":7,"get-size":19}],13:[function(require,module,exports){
/*!
 * Flickity v2.0.9
...
},{"./flickity":12,"fizzy-ui-utils":7}],15:[function(require,module,exports){
// page dots
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./flickity":12,"fizzy-ui-utils":7,"tap-listener":25}],16:[function(require,module,exports){
// player & autoPlay
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./flickity":12,"ev-emitter":6,"fizzy-ui-utils":7}],17:[function(require,module,exports){
// prev/next buttons
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./flickity":12,"fizzy-ui-utils":7,"tap-listener":25}],18:[function(require,module,exports){
// slide
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
